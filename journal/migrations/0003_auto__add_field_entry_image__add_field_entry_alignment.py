...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journal_entry', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Entry.alignment'
        db.add_column('journal_entry', 'alignment', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Entry.image'
        db.delete_column('journal_entry', 'image')

        # Deleting field 'Entry.alignment'
        db.delete_column('journal_entry', 'alignment')
    ...
    models = {
        ...
        'journal.entry': {
            ...
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 27, 14, 48, 52, 547625)'}),
