...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Entry'
        db.create_table('journal_news', (
            ('id', orm['journal.Entry:id']),
            ('title', orm['journal.Entry:title']),
            ('slug', orm['journal.Entry:slug']),
            ('excerpt', orm['journal.Entry:excerpt']),
            ('content', orm['journal.Entry:content']),
            ('is_published', orm['journal.Entry:is_published']),
            ('pub_date', orm['journal.Entry:pub_date']),
            ('created', orm['journal.Entry:created']),
            ('updated', orm['journal.Entry:updated']),
        ))
        db.send_create_signal('journal', ['Entry'])
        
        # Adding model 'LatestEntryPlugin'
        db.create_table('cmsplugin_latestnewsplugin', (
            ('cmsplugin_ptr', orm['journal.LatestEntryPlugin:cmsplugin_ptr']),
            ('limit', orm['journal.LatestEntryPlugin:limit']),
        ))
